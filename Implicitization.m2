...
traceTest (List, List, String) := Boolean => (S, F, software) -> (
    ...
    if software == "Bertini" then (
        ...
        traceStep1 = bertiniTrackHomotopy(T, T*startSystem + (1-T)*traceSlices#0, startSols);
        traceStep2 = bertiniTrackHomotopy(T, T*startSystem + (1-T)*traceSlices#1, startSols);
    ) else (
